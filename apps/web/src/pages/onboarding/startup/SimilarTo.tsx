...
const SimilarTo = ({ onNext }) => {
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-50">
      <div className="text-center">
        <h1 className="text-4xl font-bold mb-4">Find similar companies</h1>
        <p className="text-lg text-gray-600 mb-8">We'll use this to find similar companies to you.</p>
        <input
          type="text"
